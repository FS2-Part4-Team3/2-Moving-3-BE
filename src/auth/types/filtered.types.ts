...
export type FilteredPersonalInfo<T> = T extends User | IDriver ? Omit<T, 'password' | 'salt' | 'refreshToken'> : never;

export type FilteredPerson = FilteredPersonalInfo<User> | FilteredPersonalInfo<IDriver>;
