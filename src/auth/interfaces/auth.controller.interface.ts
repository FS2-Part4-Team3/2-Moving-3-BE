...
export interface IAuthController {
  signUp: (body: SignUpDTO, userType: 'user' | 'driver', res: Response) => Promise<FilteredUserWithToken>;
  signIn: (body: SignInDTO, userType: 'user' | 'driver', res: Response) => Promise<FilteredUserWithToken>;
